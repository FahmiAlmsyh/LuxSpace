...
<button type="button" id="courier" data-value="fedex" data-name="courier"
...
<div class="px-2 w-6/12 h-24 mb-4">
<button type="button"
id="courier" data-value="dhl" data-name="courier"
class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none">
...
<div class="flex -mx-2 flex-wrap">
<div class="px-2 w-6/12 h-24 mb-4">
<button type="button" data-value="midtrans"
id="payment" data-name="payment"
class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none">
...
<div class="px-2 w-6/12 h-24 mb-4">
<button type="button" data-value="mastercard"
id="payment"data-name="payment"
class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none">
...
<div class="px-2 w-6/12 h-24 mb-4">
<button type="button" data-value="bitcoin"
id="payment"data-name="payment"
class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none">
...
<div class="px-2 w-6/12 h-24 mb-4">
<button type="button" data-value="american-express"
id="payment"data-name="payment"
class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none">
