                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                  ...
                  <li>
                    <div class="flex items-center">
                      ...
                      <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Create Product</a>
                    </div>
                  </li>
                </ol>
              </nav>
        ...
        <div class="px-4 py-5 bg-white sm:p-6">
            <div class="flex-wrap -mx-3 mb-6">
                <div class="w-full px-3 ">
                    ...
                    <input type="text" placeholder="Product Name" value="{{old('title')}}" name="title" class="block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:bg-gray-500 ">
                </div>
            </div>
            <div class="flex-wrap -mx-3 mb-6 ">
                <div class="w-full px-3 ">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Description</label>
                    <textarea id="description" name="description" class="block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:bg-gray-500 ">{!! old('description') !!}</textarea>
                </div>
            </div>
            <div class="flex-wrap -mx-3 mb-6 ">
                <div class="w-full px-3 ">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Price</label>
                    <input type="number" placeholder="Product Price" value="{{old('price')}}" name="price" class="block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:bg-gray-500 ">
                </div>
            </div>
            <div class="flex-wrap -mx-3 mb-6 ">
                <div class="w-full px-3 ">
